...
from FacturaExamen import Factura
from facturaExamen2 import Factura2
...
class FiestraPrincipal (QMainWindow):
    def __init__(self):
        ...
        self.conxBD = ConexionBD("modelosClasicos.dat")
        self.conxBD.conectaBD()
        self.conxBD.creaCursor()

        clientes = self.conxBD.consultaSenParametros("Select * from clientes")
        self.conxBD.pechaBD()
        ...
        self.btonImprimir1 = QPushButton("imprimir 1")
        self.btonImprimir1.clicked.connect(lambda: self.imprimir1(self.txtNumeroCliente.text()))
        self.btonImprimir2 = QPushButton("imprimir 2")
        self.btonImprimir2.clicked.connect(lambda: self.imprimir2())
        ...
        caixaBtnAceptar.addWidget(self.btonImprimir1)
        caixaBtnAceptar.addWidget(self.btonImprimir2)
    ...
    def imprimir2(self):
        factura = Factura2(self.modelo.datos)
        print("Factura creada con exito")
    def imprimir1(self, y):
        n = int(y)
        n = n-1
        factura = Factura("facturaBD",str(self.modelo.datos[n][0]),str(self.modelo.datos[n][1]),str(self.modelo.datos[n][2]),str(self.modelo.datos[n][3]),str(self.modelo.datos[n][4]),str(self.modelo.datos[n][5]),str(self.modelo.datos[n][6]),str(self.modelo.datos[n][7]),str(self.modelo.datos[n][8]),str(self.modelo.datos[n][9]))
        print("facrtura2 creada")
