...
class ConexionBD:
    ...
    def engadeRexistro(self, insertSQL, *parametros):
        """Este metodo se encarga de añadir un registro a la base de datos,
    ...
    def actualizaRexistro(self, updateSQL, *parametros):
        """Metodo que se encarga de hacer un update de los campos en n uestra base d edatos
    ...
    def borraRexistro (self, borraSQL, *parametros):
        """Este métdoo elimina un registro de la base de datos
